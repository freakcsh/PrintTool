...
public class NetworkConnectChangedReceiver extends BroadcastReceiver {
    ...
    private static final String TAG1 = "NetworkConnectChanged1";
...
//                    RxBus.getDefault().post(new StateEvent(10,true));
//                    SPUtils.put(context, Constants.WIFI_STATE,"true");
                }
...
//                                RxBus.getDefault().post(new StateEvent(10,false));
                            }
                        }
